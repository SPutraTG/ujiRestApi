...
const fs = require("fs");
let private = fs.readFileSync(__dirname + '/private_key.pem','utf8');
let privateES = fs.readFileSync(__dirname + '/ecdsa_private_key.pem','utf8');
...
exports.login = function (req, res) {
     ...
     connection.query(query, function (error, rows) {
          if (error) {
               ...
               if (rows.length == 1) {
                    var token = jwt.sign({ rows }, privateES, {
                         algorithm: 'ES256',
